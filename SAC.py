...
from stable_baselines3.common.vec_env import SubprocVecEnv #This is new code
...
class Args:
    ...
    env_id: str = "MiniGrid-Empty-8x8-v0" # Old argument: "BeamRiderNoFrameskip-v4"
...
"""
    ...
    num_envs = 1
    envs = SubprocVecEnv([make_env(env_id, i, capture_video=False, run_name="your_run_name") for i in range(num_envs)]) #envs = gym.vector.SyncVectorEnv([make_env(args.env_id, args.seed, 0, args.capture_video, run_name)])
